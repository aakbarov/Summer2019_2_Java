...
public class ArraysMethods {
	...
	public static void main(String[] args) {
		...
		/*
		 * write a program that can print the arrays in Descending order (largest to
		 * smallest)
		 * 
		 */
		...
		/*
		 * Descending[0] = arr2[6]; Descending[1] = arr2[5]; Descending[2] = arr2[4];
		 * Descending[3] = arr2[3]; Descending[4] = arr2[2]; Descending[5] = arr2[1];
		 * Descending[6] = arr2[0];
		 */
