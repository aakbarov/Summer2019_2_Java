...
public class PracticeMethods {
	 ...
	 * result
	 * 
	 * Ex: RemoveDuplicates("aabbcccccddddaaa") output: abc
	 * 
	 */
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * String result = "" ; //"abc" for(int i=0; i < str.length(); i++) { if( !
		 * result.contains( str.substring(i, i+1)) ) { result += str.substring(i, i+1);
		 * } }
		 * 
