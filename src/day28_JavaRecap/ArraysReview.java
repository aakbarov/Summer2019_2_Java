...
public class ArraysReview {
	...
	public static void main(String[] args) {
		...
		/*
		 * single dimensional array: three ways to declare: int[] arr1D = { 1, 2, 3, 4
		 * }; int arr1D[] = { 1, 2, 3, 4 }; int arr1D[] = new int[]{ 1, 2, 3, 4 };
		 * 
		 * 
		 * 
		 */
		 ...
		 * 
		 * toString(): converting single dimensional array to String sort(): sorting
		 * single dimensional array in ascending order deepToString(): converting
