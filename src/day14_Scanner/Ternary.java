...
public class Ternary {
	...
	/*
	 * in Ternary: if(condition) ==> (Condition)? else ==> : else if(Condition) ==>
	 * :(Condition)?
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 * if(FinalGrade == 'A') { Group="Early bird"; }else if(FinalGrade =='B') {
		 * Group ="Group 1"; } else if(FinalGrade == 'C') { Group = "Group 2"; } else {
		 * Group ="After Group 2"; }
		 * 
		 */

		Group = (FinalGrade == 'A') ? "Early Birds"
				: (FinalGrade == 'B') ? "Group 1" : (FinalGrade == 'C') ? "Group 2" : "After Group 2";
		...
		Finals = (score >= 90 && score <= 100) ? 'A'
				: (score >= 80 && score <= 89) ? 'B'
						: (score >= 70 && score <= 79) ? 'C'
								: (score >= 60 && score <= 69) ? 'D' : (score >= 0 && score <= 59) ? 'F' : ' ';
