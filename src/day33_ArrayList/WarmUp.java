...
public class WarmUp {
	...
	/*
	 * Warm up: write a return method that accepts an int array and sorts it in
	 * descending order write a return method that accepts a double array and sorts
	 * it in descending order write a return method that accepts a char array and
	 * sorts it in descending order write a return method that accepts a String
	 * array and sorts it in descending order Hint: method overloading is preferred
	 * here
	 */
