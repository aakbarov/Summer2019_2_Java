...
public class WarmUp {
	/*
	 * Warm up: 1. write a return method that can remove duplicates from a string
	 * Ex: RemoveDup("abcabc") ==> returns "abc"; 2. write a return method that
	 * accepts two parameter Strings a and b, and returns the total numbers of
	 * apperence of string b in String a
	 * 
	 * Ex: count("abcaba", "a") ==> returns 3 ; 3. use the above two methods to
	 * write a new method that can find the frequency of characters Ex:
	 * frequency("aabcabcabc") ==>a4b3c3 4. write a return method that can find the
	 * maximum number from an Integer arrayList (DO NOT use sort methods of
	 * Collections class) 5. write a return method that can find the minimum number
