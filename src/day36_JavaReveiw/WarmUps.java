...
public class WarmUps {
	...
	/*
	 * WarmUp: 1. write a return method that can remove the duplicated objects from
	 * an Integer arraylist
	 * 
	 * 2. write a return method that can remove the duplicated objects from a String
	 * arraylist
	 * 
	 * 3. write a return method that can remove the duplicated objects from a
	 * Character arraylist
	 * 
	 * 4. write a return method that can remove the duplicated objects from a Double
	 * arraylist
	 */
	...
	public static ArrayList<Integer> RemoveDup(ArrayList<Integer> list) {
		...
		/*
		 * for( Integer each : list ) { if( ! result.contains(each) ) { result.add( each
		 * ); } }
		 */
		return result;
	}
