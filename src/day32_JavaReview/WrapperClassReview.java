...
public class WrapperClassReview {
	...
	/*
	 * primitives Wrapper classes: java.lang byte Byte short Auto boxing Short int
	 * ==============> Integer long Long float un-boxing Float double <=============
	 * Double boolean Boolean char Character
	 * 
	 * 
	 * wrapper class vs primitives: 1. default values: primitives: byte, short, int,
	 * long ==> 0 float, double ==> 0.0 boolean ==> false char ==>space
	 * 
	 ...
	 * 
	 * max_value: returns the maximum value of the the data-type min_value: return
	 * the minimum value of the data type parse methods: converts String to
	 * primitives valueOf methods: converts string to wrapper class
	 * 
	 * 
	 * Auto-boxing: assign the primitives to wrapper class un-boxing: assign the
	 * wrapper class to primitives
	 * 
	 * 
	 */
	public static void main(String[] args) {
		...
		/*
		 * methods: max_value min_value parse methods valueof methods
		 * 
		 */
