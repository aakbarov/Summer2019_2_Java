...
public class ArrayListReveiw {
	 ...
	 * lastIndexOf(), equals(), isEmpty(), contains(), remove(), Array.asList(),
	 * addAll(), removeAll() , sort()
	 */
	...
	public static void main(String[] args) {
		...
		// size(): returns the total number of elements in the list ( similar with
		// lenght method in array
		...
		// Contains(Object): checks if the given object is conatined in the arraylist or
		// not, and returns boolean expression
		...
		// isEmpty(): checks if the size of the ARraylist is 0 or not, returns boolean
		// expression
		...
		/*
		 * for(int i =0; i < nums.size(); i++) { if(nums.get(i) == 1 ) { nums.remove(i);
		 * } }
		 */
