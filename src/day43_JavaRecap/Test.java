...
public class Test {
	...
	public static void main(String[] args) {
		...
		// System.out.println(Testdata.salary); // default access modifier is not
		// visible outside package
		// System.out.println(Testdata.number); // protected access modfier is not
		// visible outside package
...
//		System.out.println(obj.namePublic);
		...
		// System.out.println( obj.nameDefault); // access modifier is default, only
