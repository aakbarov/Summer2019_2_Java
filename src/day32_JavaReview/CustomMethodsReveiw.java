...
public class CustomMethodsReveiw {
	 ...
	 * }
	 * 
	 * Access modifier: public specifier: static return-type: void, all primitives
	 * and non primitives methodName: anyName parameter: all data type
	 * 
	 * 
	 * 
	 * if the return type is void: method does not return any value
	 * 
	 * if the return type is NOT void: the method MUST return a value, and the
	 * returning value MUST match with return type
	 * 
	 * methods that passes parameter (with argument): method requires extra
	 * informations to perform it's task
	 * 
	 * 
	 */
