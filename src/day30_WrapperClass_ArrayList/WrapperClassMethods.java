...
public class WrapperClassMethods {
	/*
	 * useful methods of Wrapper class: Max_Value Min_Value parse methods ValueOf
	 * methods
	 */
	public static void main(String[] args) {
		...
		// parseShort("strValue"): takes the string and convrts it to short primitive
		// value
		...
		// parseDouble("StrValue"): takes string value and converts it to double
		// primitive
		...
		// parseBoolean("StrValue"): takes string value and converts to boolean
		// primitive
		...
		// ValueOf methods: converts String value to Wrapper class values, returns
