...
public class StringMethods {
	...
	/*
	 * split(str): splits the String by the given value, and returns it as String
	 * array
	 * 
	 * 
	 * toCharArray():
	...
	public static void main(String[] args) {
		...
		System.out.println(array3.length - 1); // Returns the total number of python in STring
