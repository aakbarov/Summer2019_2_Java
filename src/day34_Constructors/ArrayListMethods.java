...
public class ArrayListMethods {
	...
	/*
	 * remaining methods: indexOf(), lastIndeOf()
	 * 
	...
	public static void main(String[] args) {
		...
		// indexOf(object): returns the index number of first matching object from the
		// arrayList as an int
		// if it returns negative number, it means the given object is not exist in the
		// arraylist
		...
		// lastindexOf(object): returns the last occured object' index number (last
		// index number) as an int
		 ...
		 * 
		 * for(int i =0; i <lis.size(); i++ ) { if(lis.get(i) == 1) { lis.remove(i); } }
		 * 
